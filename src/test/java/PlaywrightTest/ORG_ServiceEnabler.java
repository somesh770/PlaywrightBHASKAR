...
public class ORG_ServiceEnabler {
	...
	public void createContext() {
		...
		page.locator("(//div[@class='styles_boxCard__jXGqM'])[8]").click();	
...
//=========================================================================================
	...
	@Test(priority = 1)
	public void BHASKAR_ORG_serviceEnabler_Complete_your_profile()
	{
		...
		Assert.assertEquals(userRoleONprofileString, "Service Enabler");
	}
	
	@Test(priority = 2)
	public void BHASKAR_ORG_serviceEnabler_Skip_to_your_DashboardCTA() {
	...
	@Test(priority = 3)
	public void BHASKAR_ORG_serviceEnabler_Publish_Your_ProfileCTA() {
		page.locator("//button[normalize-space()='Complete your profile']").click();
		System.out.println("Clicked on Complete your profile");
