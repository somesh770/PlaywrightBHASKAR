...
public class ORG_Accelerator {
	...
	public void createContext() {
		...
		page.locator("(//div[@class='styles_boxCard__jXGqM'])[4]").click();
...
//==============================================================================================
	...
	@Test(priority = 1)
	public void BHASKAR_ORG_Accelerator_Startup_Complete_your_profile() {
		...
		Assert.assertEquals(userRoleONprofileString, "Accelerator");
	}

	@Test(priority = 2)
	public void BHASKAR_ORG_Accelerator_Startup_Skip_to_your_DashboardCTA() {
	...
	@Test(priority = 3)
	public void BHASKAR_ORG_Accelerator_Startup_Publish_Your_ProfileCTA() {
		page.locator("//button[normalize-space()='Complete your profile']").click();
		System.out.println("Clicked on Complete your profile");
