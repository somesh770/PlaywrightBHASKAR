...
public class test {
	...
	public void testone() {
		...
		page.locator("//select[@placeholder='Please select your country of residence']").selectOption("5f02e38c6f3de87babe20cd2");
	...
	boolean isvisble = 	page.locator("//h6[normalize-space()='Startup Founder']").isVisible();
