...
public class ORG_InstitutionalInvestor {
	...
	public void createContext() {
		...
		page.locator("(//div[@class='styles_boxCard__jXGqM'])[9]").click();
...
//==============================================================================================
	...
	@Test(priority = 1)
	public void BHASKAR_ORG_InstitutionalInvestor_Startup_Complete_your_profile() {
		...
		Assert.assertEquals(userRoleONprofileString, "Institutional Investor");
	}

	@Test(priority = 2)
	public void BHASKAR_ORG_InstitutionalInvestor_Skip_to_your_DashboardCTA() {
	...
	@Test(priority = 3)
	public void BHASKAR_ORG_InstitutionalInvestor_Startup_Publish_Your_ProfileCTA() {
		page.locator("//button[normalize-space()='Complete your profile']").click();
		System.out.println("Clicked on Complete your profile");
