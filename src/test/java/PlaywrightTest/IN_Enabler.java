...
//====================================================================================
	@Test(priority = 1)
	public void BHASKAR_IN_Enabler_Complete_your_profile() {
		...
		Assert.assertEquals(userRoleONprofileString, "Enabler");
	}

	@Test(priority = 2)
	public void BHASKAR_IN_Enabler_Skip_to_your_DashboardCTA() {
	...
	@Test(priority = 3)
	public void BHASKAR_IN_Enabler_Publish_Your_ProfileCTA() {
		page.locator("//button[normalize-space()='Complete your profile']").click();
		System.out.println("Clicked on Complete your profile");
