...
public class ORG_GovernmentBody {
	...
	public void createContext() {
		...
		page.locator("(//div[@class='styles_boxCard__jXGqM'])[7]").click();	
...
//=========================================================================================
	...
	@Test(priority = 1)
	public void BHASKAR_ORG_GovernmentBody_Complete_your_profile()
	{
		...
		Assert.assertEquals(userRoleONprofileString, "Government Body");
	}
	
	@Test(priority = 2)
	public void BHASKAR_ORG_GovernmentBody_Skip_to_your_DashboardCTA() {
	...
	@Test(priority = 3)
	public void BHASKAR_ORG_GovernmentBody_Publish_Your_ProfileCTA() {
		page.locator("//button[normalize-space()='Complete your profile']").click();
		System.out.println("Clicked on Complete your profile");
